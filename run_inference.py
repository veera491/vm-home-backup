...
initial_peer = "/ip4/10.0.0.4/tcp/31330/p2p/12D3KooWMbChRtLcH735XLiWqtQafRhcghV38kN6TbxzZyyX23u5"
no_Vms = "7"
...
if os.path.exists(filename):
    ...
    columns = ["prompt", "word_count", "token_count", "Response Time", "No of VMs"]
